  ...
  return (
    <section className="relative py-20 md:py-28 bg-cream overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(90deg, transparent, transparent 6px, rgba(0,0,0,0.5) 6px, rgba(0,0,0,0.5) 6.5px), repeating-linear-gradient(0deg, transparent, transparent 6px, rgba(0,0,0,0.3) 6px, rgba(0,0,0,0.3) 6.5px)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 md:px-10 text-center">
        <ScrollReveal>
          {section.eyebrow && (
            <p className="font-accent text-pumpkin text-[11px] tracking-[0.25em] uppercase mb-5">
              {section.eyebrow}
            </p>
          )}
          {section.title && (
            <h2 className="font-heading text-anthracite text-2xl md:text-3xl lg:text-[2.25rem] font-bold tracking-tight mb-5">
              {section.title}
            </h2>
          )}
          {section.content && (
            <p className="font-body text-text-gray text-base md:text-[1.0625rem] leading-[1.8] max-w-[52ch] mx-auto mb-10">
              {section.content}
            </p>
          )}
