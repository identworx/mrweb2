      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-8 lg:gap-12 pt-20 pb-16 md:pt-28 md:pb-20">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-3 mb-4 lg:mb-0">
            ...
            />
            <p className="font-body text-white/70 text-sm leading-[1.8] max-w-xs mb-6">
              {brandDescription}
            </p>
            {/* Social */}
                  ...
                  <li key={link.label}>
                    <Link
                      ...
                      {...(link.target === "_blank"
                        ...
                        : {})}
                      className="font-body text-white/70 text-sm hover:text-white/90 transition-colors duration-400"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-xs">
            {legal.map((item) => (
              <Link
                key={item.label}
                href={item.href}
                className="font-body text-white/60 hover:text-white/80 transition-colors duration-400"
              >
                {item.label}
              </Link>
            ))}
