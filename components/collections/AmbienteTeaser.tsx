...
function TeaserTile({
  ...
  return (
    <Link
      href={href}
      className="relative overflow-hidden border border-black/[0.04] bg-cream group block focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pumpkin"
      style={{ gridArea: area }}
            ...
            <div className="hidden sm:grid lg:hidden grid-cols-2 gap-3">
              {filled.map((img, i) => (
                <Link
                  key={img.id}
                  href={tileHref}
                  className={`relative overflow-hidden border border-black/[0.04] bg-cream block focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pumpkin ${
