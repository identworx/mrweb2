...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t["seoTitle"] || "Product Dimensions | Mosaroma",
    description: t["seoDescription"] || "Overview of key Mosaroma product dimensions for cushions, pads, back cushions, bench cushions, poufs, placemats and table runners.",
  };
}
    ...
    <>
      ...
      <main id="main">
        ...
        <BreadcrumbBar items={[
          ...
          { label: t["breadcrumb.self"] || "Product Dimensions" },
        ]} locale="en" />
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-8">
              <div>
                <p className="font-body text-text-gray text-sm leading-relaxed">
                  {t["notice"] || "All dimensions are guide values and should be checked for fit before ordering."}
                </p>
                <p className="font-body text-text-muted text-xs mt-1">
                  {t["customNote"] || "Custom sizes on request."}
                </p>
              </div>
            </div>
            <MeasurementNavEn />
        ...
        <section id="lehner" className="section-padding bg-white">
          <div className="mx-auto max-w-[1400px] px-5 md:px-10">
            <h2 className="font-heading text-anthracite text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight mb-10">
              {t["lehnerTitle"] || "High & Low-Back Cushions"}
            </h2>
        ...
        <section id="tischsets" className="section-padding bg-cream">
          <div className="mx-auto max-w-[1400px] px-5 md:px-10">
            <h2 className="font-heading text-anthracite text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight mb-10">
              {t["tischTitle"] || "Placemats & Table Runners"}
            </h2>
        ...
        <PageCta
          variant="minimal"
          title={t["cta.title"] || "Questions about product dimensions?"}
          description={t["cta.description"] || "Contact us — we are happy to advise you on dimensions, custom sizes and availability."}
