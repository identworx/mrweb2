...
const PAGE_SLUG = "pflege-garantie";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-1">Pflege &amp; Garantie</h1>
        <p className="text-sm text-gray-500 mt-1">
          Service-Seite für Pflege- und Garantiehinweise.
        </p>
      </div>
      ...
      {page ? (
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          <p className="text-sm text-yellow-800">
            Service-Seite &bdquo;Pflege &amp; Garantie&ldquo; wurde noch nicht in der Datenbank gefunden (Slug: {PAGE_SLUG}).
          </p>
          <Link
            href="/admin/pages"
