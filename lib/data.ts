...
export const footerLinks = {
  produkte: {
    title: "Produkte",
    links: ["Sitzkissen", "Dekokissen", "Bankauflagen", "Gartenmöbel", "Loungesets", "Outdoor-Textilien"],
  },
  service: {
    title: "Service",
    links: ["Pflegehinweise", "Materialien", "Lieferung", "Reklamation"],
  },
  unternehmen: {
    title: "Unternehmen",
    links: ["Über MOSAROMA", "Geschichte", "Nachhaltigkeit", "Kontakt"],
  },
};
