...
INSERT INTO "new_NavigationItem" ("createdAt", "href", "id", "isActive", "label", "linkedPageId", "menuId", "order", "parentId", "target", "updatedAt") SELECT "createdAt", "href", "id", "isActive", "label", "linkedPageId", "menuId", "order", "parentId", "target", "updatedAt" FROM "NavigationItem";
